...
test('public company lookup uses stable ID and returns current cleared profile fields', async t => {
  ...
  const company = { businessName: 'Renamed company', location: 'Kolkata', contactMethod: 'phone', verificationMethod: 'udyam', businessProfile: { description: 'Current description', logo: '', website: '', requiredSkills: 'SQL', contactEmail: '' } }
