...
export default function CompanyTaskpage({ opportunity }) {
  ...
  const statusMeta = {
    ...
    selected: {
      ...
      copy: `${task.company} selected you for this GIG. Work details are now available in Project Workspace.`,
    },
    work_started: {
      badge: 'Work Started',
      bg: '#EDE9FE',
      ...
      copy: `${task.company} marked this GIG as in progress.`,
    },
    delivered: {
      badge: 'Delivered',
      bg: '#FEF3C7',
      ...
      copy: 'Your deliverable is waiting for company approval.',
    },
    approved: {
      badge: 'Approved',
      bg: '#DBEAFE',
      color: '#1D4ED8',
      title: 'Work Approved',
      copy: `${task.company} approved your work. Completion and payment processing can now proceed.`,
    },
    completed: {
      badge: 'Completed',
      bg: '#D1FAE5',
      color: '#065F46',
      title: 'GIG Completed',
      copy: `${task.company} marked this GIG complete. Your TrustScore completion credit has been recorded.`,
    },
    needs_revision: {
