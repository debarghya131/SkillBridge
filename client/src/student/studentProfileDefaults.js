...
export function mergeStudentProfile(student = {}) {
  ...
  return {
    ...
    about: typeof student.about === 'string' ? student.about : DEFAULT_STUDENT_PROFILE.about,
    collaborationFocus: Array.isArray(student.collaborationFocus) ? student.collaborationFocus : [...DEFAULT_STUDENT_PROFILE.collaborationFocus],
    workStyle: typeof student.workStyle === 'string' ? student.workStyle : DEFAULT_STUDENT_PROFILE.workStyle,
